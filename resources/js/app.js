...
// 1. Allows users to enter names into a text bodocument.getElementById("myText").value = "Johnny Bravo";
...
const classRoster = ['Derrick','Valentina','Sri'];
...
function generateRandomName (){
    ...
    }else{ for (let i = 0; i < numOfNames; i++) {
...
generate.addEventListener('click', generateRandomName);
